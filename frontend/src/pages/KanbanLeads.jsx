...
function maskPhone(phone) {
  ...
  return formatted ? formatted.replace(/\d/g, '•') : formatted
}

function displayPhone(phone, demoMode) {
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 text-xs font-medium px-3 py-2 rounded-lg border transition ${
              demoMode ? 'bg-amber-50 border-amber-200 text-amber-700' : 'border-slate-200 text-slate-500 hover:bg-slate-100'
            }`}
          >
